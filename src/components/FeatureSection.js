...
export default function FeatureSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Stake tokens across multiple chains to earn MOCA tokensns while playing your favorite games with minimal slippage.",
      icon: "⛓️"
    },
    {
      id: 3,
          ...
          <div className="lg:col-span-7 p-[1px] bg-gradient-to-r from-red-magic to-blue-magic rounded-xl">
            <div className="bg-[#1A0015] rounded-xl p-6 md:p-8">
              ...
              <p className="text-white/80 text-sm">
                APT-Casino leverages Monad Network Blockchain to provide a transparent, provably fair gaming
