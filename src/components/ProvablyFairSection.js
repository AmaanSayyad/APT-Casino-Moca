  ...
  const steps = [
    {
      ...
      description: 'When you start a game, a randomness request is sent to Pyth Network Entropy on Moca Network. The request includes a custom gas limit and required fee.',
      icon: 'client-seed',
    ...
    },
    {
      ...
      description: 'All randomness requests and results are recorded on Moca Network blockchain, providing complete transparency and verifiability.',
      icon: 'calculation',
            ...
            <div className="p-[1px] bg-gradient-to-r from-red-magic to-blue-magic rounded-xl h-full">
              <div className="bg-[#1A0015] rounded-xl p-6 h-full">
                ...
                <p className="text-white/80 mb-6">
                  ...
                  It aggregates randomness from multiple sources and makes it available to smart contracts on Moca Network.
                </p>
