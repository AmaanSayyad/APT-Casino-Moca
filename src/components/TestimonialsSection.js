  ...
  const testimonials = [
    {
      ...
      rating: 5,
              text: 'APT Casino offers the most transparent gaming experience I\'ve found on Monad Network. The provably fair system gives me confidence that games are legitimate, and I\'ve already won over 500 MOCA tokensns!',
      game: 'Roulette',
      amount: 520
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: 'The DeFi lending integration is brilliant. I was able to use my collateral to borrow MOCA for games, and when I won big, I paid back the loan and kept the profits. Smart financial gaming!',
      game: 'Fortune Tiger',
      amount: 876
    },
    {
                ...
                <div className="mt-auto pt-6 border-t border-white/10">
                  <div className="flex justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold">{testimonials[activeIndex].amount} MOCA</p>
                    </div>
                  </div>
                </div>
              </div>
