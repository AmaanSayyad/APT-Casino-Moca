  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-end gap-6 md:gap-8 text-white bg-black/20 backdrop-blur-sm p-4 rounded-xl border border-white/5 shadow-lg">
      ...
      <div className="flex flex-col items-center md:items-end">
        ...
        <p className="font-display font-bold text-xl md:text-2xl bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">4.7M MOCA</p>
      </div>
      ...
      <div className="flex flex-col items-center md:items-end">
        ...
        <p className="font-display font-bold text-xl md:text-2xl bg-gradient-to-r from-green-300 to-teal-300 bg-clip-text text-transparent">121,750 MOCA</p>
      </div>
    </div>
  );
};
