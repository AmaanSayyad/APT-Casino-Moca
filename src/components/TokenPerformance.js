    ...
    <section className="py-16 px-4 md:px-8 lg:px-16 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center mb-8">
          ...
          <h2 className="text-2xl font-display font-bold text-white">MOCA tokenn Performance</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  <div className="flex items-center">
                    ...
                    <h3 className="text-white text-xl font-medium">MOCA</h3>
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            ...
            <div className="p-[1px] bg-gradient-to-r from-red-magic to-blue-magic rounded-xl">
              <div className="bg-[#1A0015] rounded-xl p-6">
                <h3 className="text-white text-lg font-medium mb-2">Ready to invein MOCAMOCA?</h3>
                <p className="text-white/70 text-sm mb-4">
                  Stake MOCA to earn passive income while playing your favorite games.
                </p>
                <Link href="/bank">
