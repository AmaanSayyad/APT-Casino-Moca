...
// Moca Chain Treasury address from environment
const MOCA_TREASURY_ADDRESS = process.env.MOCA_TREASURY_ADDRESS || process.env.TREASURY_ADDRESS;
...
export async function POST(request) {
  try {
    ...
    console.log(`🏦 Processing deposit: ${amount} MOCA from ${userAddress}`);
    console.log(`📍 Moca Treasury: ${MOCA_TREASURY_ADDRESS}`);
    
    // Simulate processing delay
    await new Promise(resolve => setTimeout(resolve, 1000));
    
    console.log(`✅ Deposit successful: ${amount} MOCA from ${userAddress}`);
    ...
    return NextResponse.json({
      ...
      treasuryAddress: MOCA_TREASURY_ADDRESS,
      status: 'confirmed',
