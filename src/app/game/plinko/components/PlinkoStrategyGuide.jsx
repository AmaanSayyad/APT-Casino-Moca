  ...
  const strategies = [
    {
      ...
      example: 'Set risk to Low, rows to 16, bet 0.1–0.25 MOCA, play many rounds and cash out on streaks.'
    },
    {
      id: 's2',
      ...
      example: 'Risk Medium, rows 15, bet 0.25–0.5 MOCA. Stop-loss and take-profit rules keep variance under control.'
    },
    {
      id: 's3',
      ...
      example: 'Risk High, rows 12–14, small fixed bet (e.g., 0.1 MOCA) and strict stop-loss.'
    }
  ];
