...
// Utility function to format MOCA amounts with proper decimal precisionn
                  ...
                  <TableBody>
                    {bets.map((bet) => (
                      ...
                      >
                        ...
                        <TableCell align="center">{formatMONAmount(bet.amount || bet.totalBetAmount || 0)} MOCA</TableCell>
                          ...
                          >
                            {bet.win ? (
                              <>
                                ...
                                +{formatMONAmount(bet.payout || bet.netResult || 0)} MOCA
                              </>
                            ) : '-'}
                          </Typography>
                        </TableCell>
              ...
              <Box>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, mb: 4 }}>
                  ...
                  >
                    ...
                    <Typography variant="h4" fontWeight="bold" color="white" sx={{ textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}>{formatMONAmount(stats.totalWagered)} MOCA</Typography>
                  </Box>
                  ...
                  >
                    ...
                    >
                      {stats.netProfit >= 0 ? '+' : ''}{formatMONAmount(stats.netProfit)} MOCA
                    </Typography>
                  </Box>
                </Box>
